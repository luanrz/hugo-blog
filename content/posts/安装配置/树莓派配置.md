...
tags: 
- Linux
description: 树莓派配置, 包括常用开发环境及部分实用工具的安装与配置
---
...
2. 配置数据库
    ...
    2. `update mysql.user set authentication_string=PASSWORD('root'), plugin='mysql_native_password' where user='root';`
...
- ## 开机后自动推送IP至邮箱
    ...
    新增"获取IP并发邮件"的[脚本](http://shumeipai.nxez.com/2014/03/18/let-raspberry-pi-ip-address-is-automatically-reported-to-the-mailbox.html)
